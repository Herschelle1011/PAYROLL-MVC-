export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-700 px-4 ">
      <div className="w-full max-w-md rounded-xl bg-white/50 p-8 shadow-lg  backdrop-blur-sm">
        {/* Logo / Title */}
        ...
        <form className="space-y-5">
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center gap-2 text-gray-600">
              <input
                type="checkbox"
                className="rounded border-gray-300 text-blue-600 opacity: 0.9 focus:ring-blue-500"
              />
              Remember me
            </label>
